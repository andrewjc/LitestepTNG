...
namespace nCore {
UINT64 LoadFolder(LoadFolderRequest &request, FileSystemLoaderResponseHandler *handler);
UINT64 LoadFolderItem(LoadItemRequest &request, FileSystemLoaderResponseHandler *handler);
